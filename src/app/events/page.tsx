    ...
    <div className="flex flex-col min-h-screen bg-[#0A0A0A] text-[#F5F5F5]">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-[#CFCFCF] max-w-3xl mx-auto leading-relaxed mb-12">
              ...
              <button
                ...
                className={`px-6 py-3 text-sm uppercase tracking-wider transition-colors border-b-2 ${
                  activeTab === tab.id
                    ...
                    : 'border-transparent text-[#CFCFCF] hover:text-[#F5F5F5]'
                }`}
              >
                {tab.label}
              </button>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <div key={item} className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg overflow-hidden hover:border-[#D4AF37]/50 transition-colors">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-[#CFCFCF] text-sm mb-4">January 25, 2025 • 7:00 PM</p>
            ...
            <div className="mt-12 text-center">
              <p className="text-[#CFCFCF] mb-6">Interactive calendar with short summaries coming soon.</p>
              <button 
                onClick={() => setShowApplyModal(true)}
      ...
      {activeTab === 'past' && (
        <section className="py-12 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <div key={item} className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg overflow-hidden hover:border-[#D4AF37]/50 transition-colors group">
                  <div className="h-64 bg-gradient-to-br from-[#1D3B2A]/50 to-[#3C5F3C]/50 flex items-center justify-center relative overflow-hidden">
                    <div className="absolute inset-0 bg-[#0A0A0A]/40 group-hover:bg-[#0A0A0A]/20 transition-colors"></div>
                    <div className="relative z-10 text-center">
                      ...
                      <p className="text-sm text-[#CFCFCF]">Photo/Video Gallery</p>
                    </div>
                  </div>
                  <div className="p-6">
                    ...
                    <p className="text-[#CFCFCF] text-sm mb-4">December 15, 2024</p>
                    <p className="text-[#CFCFCF] text-sm leading-relaxed">
            ...
            <div className="mt-12 text-center">
              <p className="text-[#CFCFCF]">Photo/video gallery with highlights coming soon.</p>
            </div>
          </div>
        </section>
      )}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              {[
                ...
                <div key={index} className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-8 hover:border-[#D4AF37]/50 transition-colors">
                  <h3 className="text-2xl font-serif font-semibold mb-4 text-[#D4AF37]">{experience.title}</h3>
                  <p className="text-[#CFCFCF] leading-relaxed mb-6">{experience.desc}</p>
                  <button 
                    onClick={() => setShowApplyModal(true)}
      ...
      {showApplyModal && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4" onClick={() => setShowApplyModal(false)}>
          <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-[#CFCFCF] mb-6">Elite Connect events are exclusive to members. Request access or membership invitation.</p>
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); setShowApplyModal(false); }}>
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-[#CFCFCF]">Event Interest</label>
