              ...
              <button
                ...
                className={`px-6 py-2 text-sm uppercase tracking-wider transition-colors border ${
                  activeCategory === category.id
                    ...
                    : 'border-[#2A2A2A] text-[#CFCFCF] hover:border-[#2A2A2A]/50'
                }`}
              >
                {category.label}
              </button>
        ...
        <section className="py-12 px-6 bg-[#1A1A1A]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {[1, 2, 3].map((item) => (
                <div key={item} className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-lg overflow-hidden hover:border-[#D4AF37]/50 transition-colors">
      ...
      {(activeCategory === 'all' || activeCategory === 'thoughts') && (
        <section className="py-12 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-8 hover:border-[#D4AF37]/50 transition-colors">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-[#CFCFCF]">January 15, 2025</span>
                    <button className="text-sm text-[#D4AF37] hover:underline uppercase tracking-wide">
                      Read More →
                    </button>
                  </div>
      ...
      {showApplyModal && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4" onClick={() => setShowApplyModal(false)}>
          <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-[#CFCFCF] mb-6">Elite Connect membership and investment access are limited and reviewed individually.</p>
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); setShowApplyModal(false); }}>
              ...
              <div>
                ...
                <input type="text" required className="w-full bg-[#0A0A0A] border border-[#2A2A2A] rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent" placeholder="Entrepreneur, CEO, Designer..." />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea required rows={6} className="w-full bg-[#0A0A0A] border border-[#2A2A2A] rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent resize-none" placeholder="Tell us about yourself and your motivation to join Elite Connect..." />
              </div>
